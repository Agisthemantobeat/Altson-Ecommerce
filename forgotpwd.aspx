<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="forgotpwd.aspx.cs" Inherits="ALTSON_NEW.forgotpwd" %>
        ...
        <div class="box-collapse">
            ...
            <div class="box-collapse-wrap form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <asp:Button ID="Button2" type="submit" class="btn btn-b" runat="server" Text="Search" />
                ...
                <div class="text-center">
                  ...
                  <div class="panel-body">
                    ...
                    <form id="form1" runat="server" role="form" autocomplete="off" class="form" method="post">
                      ...
                      <div class="form-group">
                        <div class="input-group  px-auto" style="left: 0px; top: 31px; height: 42px">
                          <span class="input-group-addon"><i class="glyphicon glyphicon-envelope color-blue"></i></span>
                          <input id="email" name="email" placeholder="email address" class="form-control"  type="email" />
                        </div>
                      </div>
                      <div class="form-group">
                          <asp:Button ID="Button1" runat="server" text="Reset your password" name="recover-submit" class=" btn btn-dark" style=" height:100%;width:100%;padding-top:20px;" value="Reset Password"  type="submit" onclick="Button1_Click" />
                      </div>
